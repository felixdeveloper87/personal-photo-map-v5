...
const CTASection = ({ onOpenRegister }) => {
  ...
  const decorGradient = useColorModeValue(
    'radial(circle, blackAlpha.100, transparent)',
        ...
        <VStack spacing={12} textAlign="center">
          ...
          <VStack spacing={8} maxW="900px">
            <Badge
              bgGradient={useColorModeValue(
                'linear(135deg, orange.500, red.500)',
            ...
            >
              Join thousands of creators, learners, and travelers who are
              already transforming their travel memories into stunning videos
              and expanding their understanding of the world through
          ...
          <VStack spacing={{ base: 6, md: 8 }}>
            ...
            <VStack spacing={4} pt={4}>
                ...
                {[
                  {
                    ...
                    shadowDark: 'rgba(72, 187, 120, 0.5)',
                    text: 'No credit card required',
                  },
                  {
                    color: 'blue.500',
                    shadow: 'rgba(66, 153, 225, 0.3)',
                    shadowDark: 'rgba(66, 153, 225, 0.5)',
                    text: 'Access to World Bank data',
                  },
                  {
                    color: 'purple.500',
                    shadow: 'rgba(128, 90, 213, 0.3)',
                    shadowDark: 'rgba(128, 90, 213, 0.5)',
                  ...
                  <HStack key={i} spacing={2}>
                    <Box
                      ...
                      boxShadow={useColorModeValue(
                        `0 0 10px ${item.shadow}`,
                        `0 0 10px ${item.shadowDark}`
                      )}
                    />
              ...
              >
                Start your educational journey today and discover the world
