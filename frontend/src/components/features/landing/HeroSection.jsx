            ...
            >
              <Badge
                ...
                _before={{
                  ...
                  bottom: '-2px',
                  bgGradient:
                    'linear(135deg, rgba(255,255,255,0.1), rgba(255,255,255,0.05))',
                  borderRadius: 'full',
                  zIndex: -1,
                }}
              >
            ...
            >
              <Heading
                ...
                _before={{
                  ...
                  bottom: 0,
                  bgGradient:
                    'linear(135deg, rgba(255,255,255,0.05), rgba(255,255,255,0.02))',
                  borderRadius: 'xl',
                  zIndex: -1,
                  transform: 'scaleX(0)',
            ...
            >
              <Text
                ...
                _before={{
                  ...
                  bottom: 0,
                  bgGradient:
                    'linear(135deg, rgba(255,255,255,0.03), rgba(255,255,255,0.01))',
                  borderRadius: 'lg',
                  zIndex: -1,
                }}
              >
                Upload and organize your travel photos by countries and
                dates, learn about each destination with comprehensive
                educational data, and create professional videos ready to
